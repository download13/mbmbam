...
var Player = function (_Component) {
  ...
  _createClass(Player, [{
    ...
    value: function load() {
      var place = void 0;
      try {
        var _JSON$parse = JSON.parse(localStorage.getItem('place')),
...
function getEpisodes(name) {
  return new Promise(function (resolve, reject) {
    ...
    x.onload = function () {
      return resolve(JSON.parse(x.responseText));
    };
    x.onerror = reject;
    x.send();
  });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_preact__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_player__ = __webpack_require__(1);
